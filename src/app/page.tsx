...
export default async function Home() {
  //WIP: Challenge to setup billing card -> Refer to Degrees or Automation
  const posts:
    | {
        id: string;
        title: string;
    ...
    <main>
      ...
      <section>
        <div className="flex items-center justify-center flex-col mt-[80px] gap-4">
          ...
          <Image
            src="/images/Degrees-ai-logo2.png"
            width={500}
            height={100}
            alt="Logo"
          ...
          <p className="text-center max-w-[500px]">
            Your AI powered sales assistant! Embed Degrees AI into any website
      ...
      {/* <ScrollArea className="h-[1200px] max-w-max flex justify-center items-center rounded-md lg:m-8 m-4 border"> */}
        <section className="md:grid-cols-3 grid-cols-1 grid gap-5 container mt-8 mb-4">
          {posts &&
            posts.map((post) => (
