...
//Sort OpenAI api for learning. Add one "$..." and set a cap so it does not go above that.
type Props = {
  errors: any
...
export const BotWindow = forwardRef<HTMLDivElement, Props>(
  (
    ...
    console.log(errors)
    return (
      <div className="w-[350px] h-[650px] flex flex-col bg-white rounded-xl border-[1px] overflow-hidden">
        ...
        <div className="flex justify-center ">
          <p className="text-gray-400 text-xs">Powered By Degrees AI</p>
        </div>
      </div>
    )
  }
